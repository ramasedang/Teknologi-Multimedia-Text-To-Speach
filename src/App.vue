    ...
    <nav class="navbar navbar-expand-lg bg-transparent">
      <div class="container-fluid">
        <a class="navbar-brand text-white" href="#">
          <img
            src="https://www.linkpicture.com/q/pngwing.com_92.png"
            height="50"
            alt="MDB Logo"
          /> Kelompok 5
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <router-link class="nav-link text-white" to="/">TTS1</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link text-white" to="/home3">Baca Berita</router-link>
            </li>
            <li class="nav-item">
